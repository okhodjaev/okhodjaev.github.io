---
title: "When the Center Speaks for the Periphery: AI Governance and the Limits of Moral Declaration"
date: 2026-06-02
permalink: /analysis/magnifica-humanitas-ai-governance/
description: "Pope Leo XIV's encyclical Magnifica Humanitas enters the AI governance debate as a major institutional signal. A structural reading from the periphery."
tags: [AI governance, institutional analysis, Global South, agency transfer, moral declaration]
layout: single
author_profile: false
classes: wide
toc_icon: "file-text"
excerpt: "The encyclical warns against the concentration of moral authority in AI. It does not address what happens when there is no institutional capacity left to challenge that authority."
---

#### Contents

- [I. The Document as Institutional Signal](#i-the-document-as-institutional-signal)
- [II. Three Institutional Signals from the Text](#ii-three-institutional-signals-from-the-text)
- [III. The Contradiction the Document Cannot Resolve](#iii-the-contradiction-the-document-cannot-resolve)
- [IV. The Question That Remains Open](#iv-the-question-that-remains-open)
