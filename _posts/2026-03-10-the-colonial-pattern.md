---
title: "The Colonial Pattern: Whoever Writes the Rules Controls the Technology"
date: 2026-03-10
permalink: /essays/the-colonial-pattern/
description: "AI governance is reproducing a structural pattern older than artificial intelligence itself: rules written by a few, applied to many, with benefits concentrated at the center and risks distributed to the periphery."
tags: [AI governance, Global South, institutional design, systemic risk, geopolitics]
layout: single
author_profile: false
classes: wide
toc_icon: "file-text"
excerpt: "The institutions shaping AI governance are reproducing a pattern older than artificial intelligence itself: whoever writes the rules controls the technology. Most of humanity will live under frameworks they had no meaningful part in designing."
---

#### Contents

- [I. The Architecture of External Standards](#i-the-architecture-of-external-standards)
- [II. Extraction Without Representation](#ii-extraction-without-representation)
- [III. The Center Decides, the Periphery Executes](#iii-the-center-decides-the-periphery-executes)
- [IV. Why This Pattern Is More Durable in AI Than Previous Cycles](#iv-why-this-pattern-is-more-durable-in-ai-than-previous-cycles)
...
**\[2\]** National Institute of Standards and Technology. *Artificial Intelligence Risk Management Framework (AI RMF 1.0).* NIST AI 100-1. U.S. Department of Commerce, January 2023. [nist.gov](https://doi.org/10.6028/NIST.AI.100-1)

**\[3\]** G7 Hiroshima AI Process. *International Guiding Principles for Advanced AI Systems and Code of Conduct for Advanced AI Systems.* October 30, 2023. [g7hiroshima.go.jp](https://www.g7hiroshima.go.jp/documents/)

**\[4\]** Bletchley Declaration on AI Safety, November 1, 2023 (28 countries); Seoul Ministerial Statement for Advancing AI Safety, May 21, 2024. UK Department for Science, Innovation and Technology. [gov.uk](https://www.gov.uk/government/publications/ai-safety-summit-2023-the-bletchley-declaration)

**\[5\]** UNESCO. *Recommendation on the Ethics of Artificial Intelligence.* Adopted by the General Conference at its 41st session, November 23, 2021. 193 member states. [unesdoc.unesco.org](https://unesdoc.unesco.org/ark:/48223/pf0000381137)

**\[6\]** International Energy Agency. *Energy Technology Perspectives 2023* and related critical minerals analysis. The DRC supplies approximately 70% of global cobalt production; China approximately 60% of rare earth elements; Indonesia approximately 40% of nickel; Australia and Chile are among the leading lithium mining jurisdictions. [iea.org](https://www.iea.org/reports/energy-technology-perspectives-2023)

**\[7\]** Perrigo, Billy. "Exclusive: OpenAI Used Kenyan Workers on Less Than $2 Per Hour to Make ChatGPT Less Toxic." *TIME*, January 18, 2023. [time.com](https://time.com/6247678/openai-chatgpt-kenya-workers/). See also: Gray, Mary L. and Siddharth Suri. *Ghost Work: How to Stop Silicon Valley from Building a New Global Underclass.* Houghton Mifflin Harcourt, 2019.

**\[8\]** Stanford HAI. *AI Index Report 2024.* Stanford University, 2024. Chapter on geographic concentration of frontier AI research and development. [aiindex.stanford.edu](https://aiindex.stanford.edu/report/)
...
**\[10\]** African Union. *Continental Artificial Intelligence Strategy.* AU, 2024. [au.int](https://au.int/); ASEAN. *ASEAN Guide on AI Governance and Ethics.* ASEAN, 2024. [asean.org](https://asean.org/)

**\[11\]** International AI Safety Report 2026. *The International AI Safety Report: An Independent Scientific Assessment.* January 2026. Current frontier training runs already cost approximately $500 million in computational resources alone; next-generation models are projected to require $1–10 billion. [internationalaisafetyreport.org](https://internationalaisafetyreport.org/publication/international-ai-safety-report-2026)

Full essay and updated sources: [okhodjaev.com/essays/the-colonial-pattern/](https://okhodjaev.com/essays/the-colonial-pattern/)

---

**Cite this work:** Khodjaev, O. (2026). *The Colonial Pattern: Whoever Writes the Rules Controls the Technology.* Zenodo. <a href="https://doi.org/10.5281/zenodo.19661731" target="_blank">doi.org/10.5281/zenodo.19661731</a>
